...
as List<String>,dailyTargetServices: null == dailyTargetServices ? _self.dailyTargetServices : dailyTargetServices // ignore: cast_nullable_to_non_nullable
as int,dailyTargetRevenue: null == dailyTargetRevenue ? _self.dailyTargetRevenue : dailyTargetRevenue // ignore: cast_nullable_to_non_nullable
...
@override@JsonKey(fromJson: looseIntFromJson) final  int dailyTargetServices;
/// Optional daily revenue goal (salon currency).
@override@JsonKey(fromJson: looseDoubleFromJson) final  double dailyTargetRevenue;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,salonId,name,email,username,usernameLower,role,uid,phone,commissionRate,commissionValue,commissionPercentage,commissionFixedAmount,commissionType,hourlyRate,baseSalary,isPayrollEnabled,payrollCurrency,status,avatarUrl,attendanceRequired,isBookable,publicBio,displayOrder,workingHoursProfileId,payrollPeriodOverride,hiredAt,const DeepCollectionEquality().hash(_assignedServiceIds),dailyTargetServices,dailyTargetRevenue,isActive,weeklyAvailability,mustChangePassword,createdAt,updatedAt]);
