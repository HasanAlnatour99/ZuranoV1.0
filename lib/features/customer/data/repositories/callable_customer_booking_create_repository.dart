...
class CallableCustomerBookingCreateRepository
  ...
  Map<String, dynamic> _serializedDraft(
    ...
    return <String, dynamic>{
      ...
      'customerCountryIsoCode': draft.customerCountryIsoCode?.trim() ?? '',
      'customerDialCode': draft.customerDialCode?.trim() ?? '',
      'customerPhoneNational': draft.customerPhoneNational?.trim() ?? '',
