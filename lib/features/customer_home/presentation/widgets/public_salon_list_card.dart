...
/// Customer-safe nearby salon row backed by [PublicSalonModel].
///
/// - Shows "New salon" instead of "0.0 (0)" for salons with no reviews yet.
/// - Distance label only renders when GPS + salon `location` are both known.
class PublicSalonListCard extends ConsumerWidget {
  const PublicSalonListCard({
    super.key,
    required this.salon,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final isNew = salon.ratingCount == 0;
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      salon.salonName.isNotEmpty ? salon.salonName : '—',
                      maxLines: 1,
