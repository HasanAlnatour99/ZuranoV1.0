...
_SalonService _$SalonServiceFromJson(Map<String, dynamic> json) =>
    _SalonService(
      ...
      categoryId: nullableLooseStringFromJson(json['categoryId']),
      categoryName: nullableLooseStringFromJson(json['categoryName']),
      categoryNameAr: nullableLooseStringFromJson(json['categoryNameAr']),
      categoryIconKey: nullableLooseStringFromJson(json['categoryIconKey']),
      isPublic: json['isPublic'] == null
          ? true
          : trueBoolFromJson(json['isPublic']),
...
Map<String, dynamic> _$SalonServiceToJson(_SalonService instance) =>
    <String, dynamic>{
      ...
      'categoryIconKey': instance.categoryIconKey,
