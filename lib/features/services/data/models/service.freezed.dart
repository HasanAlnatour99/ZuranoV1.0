...
@JsonKey(fromJson: nullableLooseStringFromJson) String? get iconKey;/// Discovery catalogue id (e.g. `beard`, `haircut`) — mirrors customer home categories.
@JsonKey(fromJson: nullableLooseStringFromJson) String? get categoryId;/// English category label at save time (customer discovery / search index).
@JsonKey(fromJson: nullableLooseStringFromJson) String? get categoryName;/// Arabic category label for discovery (`customerDiscovery/*/items`).
@JsonKey(fromJson: nullableLooseStringFromJson) String? get categoryNameAr;/// Icon key for discovery tiles (often same as [categoryId]).
@JsonKey(fromJson: nullableLooseStringFromJson) String? get categoryIconKey;/// Listed to customers when true (with salon `isPublic` and active catalog rules).
@JsonKey(fromJson: trueBoolFromJson) bool get isPublic;/// Optional marketing image URL (owner catalog / future customer UI).
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,salonId,name,serviceName,nameAr,durationMinutes,price,description,categoryKey,categoryLabel,customCategoryName,category,iconKey,categoryId,categoryName,categoryNameAr,categoryIconKey,isPublic,imageUrl,timesUsed,totalRevenue,isActive,bookable,createdAt,updatedAt]);

@override
String toString() {
  return 'SalonService(id: $id, salonId: $salonId, name: $name, serviceName: $serviceName, nameAr: $nameAr, durationMinutes: $durationMinutes, price: $price, description: $description, categoryKey: $categoryKey, categoryLabel: $categoryLabel, customCategoryName: $customCategoryName, category: $category, iconKey: $iconKey, categoryId: $categoryId, categoryName: $categoryName, categoryNameAr: $categoryNameAr, categoryIconKey: $categoryIconKey, isPublic: $isPublic, imageUrl: $imageUrl, timesUsed: $timesUsed, totalRevenue: $totalRevenue, isActive: $isActive, bookable: $bookable, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
@JsonKey(fromJson: looseStringFromJson) String id,@JsonKey(fromJson: looseStringFromJson) String salonId,@JsonKey(fromJson: looseStringFromJson) String name,@JsonKey(fromJson: looseStringFromJson) String serviceName,@JsonKey(fromJson: looseStringFromJson) String nameAr,@JsonKey(fromJson: looseIntFromJson) int durationMinutes,@JsonKey(fromJson: looseDoubleFromJson) double price,@JsonKey(fromJson: nullableLooseStringFromJson) String? description,@JsonKey(fromJson: nullableLooseStringFromJson) String? categoryKey,@JsonKey(fromJson: nullableLooseStringFromJson) String? categoryLabel,@JsonKey(fromJson: nullableLooseStringFromJson) String? customCategoryName,@JsonKey(fromJson: nullableLooseStringFromJson) String? category,@JsonKey(fromJson: nullableLooseStringFromJson) String? iconKey,@JsonKey(fromJson: nullableLooseStringFromJson) String? categoryId,@JsonKey(fromJson: nullableLooseStringFromJson) String? categoryName,@JsonKey(fromJson: nullableLooseStringFromJson) String? categoryNameAr,@JsonKey(fromJson: nullableLooseStringFromJson) String? categoryIconKey,@JsonKey(fromJson: trueBoolFromJson) bool isPublic,@JsonKey(fromJson: nullableLooseStringFromJson) String? imageUrl,@JsonKey(fromJson: nullableLooseIntFromJson) int? timesUsed,@JsonKey(fromJson: nullableLooseDoubleFromJson) double? totalRevenue,@JsonKey(fromJson: trueBoolFromJson) bool isActive,@JsonKey(fromJson: trueBoolFromJson) bool bookable,@JsonKey(fromJson: nullableFirestoreDateTimeFromJson, toJson: nullableFirestoreDateTimeToJson) DateTime? createdAt,@JsonKey(fromJson: nullableFirestoreDateTimeFromJson, toJson: nullableFirestoreDateTimeToJson) DateTime? updatedAt
});
...
switch (_that) {
case _SalonService() when $default != null:
return $default(_that.id,_that.salonId,_that.name,_that.serviceName,_that.nameAr,_that.durationMinutes,_that.price,_that.description,_that.categoryKey,_that.categoryLabel,_that.customCategoryName,_that.category,_that.iconKey,_that.categoryId,_that.categoryName,_that.categoryNameAr,_that.categoryIconKey,_that.isPublic,_that.imageUrl,_that.timesUsed,_that.totalRevenue,_that.isActive,_that.bookable,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@override@JsonKey(fromJson: nullableLooseStringFromJson) final  String? categoryId;
/// English category label at save time (customer discovery / search index).
@override@JsonKey(fromJson: nullableLooseStringFromJson) final  String? categoryName;
/// Arabic category label for discovery (`customerDiscovery/*/items`).
@override@JsonKey(fromJson: nullableLooseStringFromJson) final  String? categoryNameAr;
/// Icon key for discovery tiles (often same as [categoryId]).
@override@JsonKey(fromJson: nullableLooseStringFromJson) final  String? categoryIconKey;
/// Listed to customers when true (with salon `isPublic` and active catalog rules).
@override@JsonKey(fromJson: trueBoolFromJson) final  bool isPublic;
